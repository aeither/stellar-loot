...
export const networks = {
  testnet: {
    ...
    contractId: "CCYEZXNP5ONVCHZKVGANE5XGLRCGKMNVTQOF5ASV6BY7NX7VZVEAQIQB",
  }
} as const
...
export interface Client {
   ...
   */
  update_message: ({caller, new_message}: {caller: string, new_message: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAFaGVsbG8AAAAAAAABAAAAAAAAAAJ0bwAAAAAAEQAAAAEAAAPqAAAAEQ==",
        "AAAAAAAAAAAAAAAOdXBkYXRlX21lc3NhZ2UAAAAAAAIAAAAAAAAABmNhbGxlcgAAAAAAEwAAAAAAAAALbmV3X21lc3NhZ2UAAAAAEQAAAAA=" ]),
      options
    )
  }
