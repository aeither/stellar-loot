...
export const networks = {
  testnet: {
    ...
    contractId: "CCD6PQXGLYJFDESRMKHWYIPIVNHTKVSLVHXQIJXBGTA4SFDSNXIIIIWX",
  }
} as const
...
export interface Client {
   ...
   */
  owner_of: ({token_id}: {token_id: i128}, options?: {
    /**
   ...
   */
  is_approved: ({operator, token_id}: {operator: string, token_id: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  transfer: ({owner, to, token_id}: {owner: string, to: string, token_id: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  approve: ({owner, to, token_id}: {owner: string, to: string, token_id: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  transfer_from: ({spender, from, to, token_id}: {spender: string, from: string, to: string, token_id: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  public readonly fromJSON = {
    owner_of: this.txFromJSON<string>,
        tokens_of: this.txFromJSON<Array<i128>>,
